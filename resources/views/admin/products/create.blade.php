...
<form action="{{ route('admin.products.store') }}" method="POST" class="bg-white shadow rounded-lg p-6">
    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <input type="number" step="0.01" name="base_price" id="base_price" required value="{{ old('base_price') }}" 
                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
        </div>
        ...
        <div>
            ...
            <div class="mt-3" id="image-preview-container" style="display: none;">
                <img id="image-preview" src="" alt="Image Preview" class="max-w-xs max-h-40 rounded">
            </div>
        </div>
